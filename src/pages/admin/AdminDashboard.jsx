  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-6">
          ...
          <div className="bg-white rounded-lg shadow p-4 sm:p-6 mb-6">
            ...
            <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
              <button 
                ...
                className="bg-blue-50 hover:bg-blue-100 p-3 sm:p-4 rounded-lg text-center transition-all transform hover:scale-105 border border-blue-200 group"
              >
                ...
                <h3 className="font-medium text-blue-900 text-sm sm:text-base">Add Category</h3>
              </button>
              
              <button 
                onClick={() => openProductModal()} 
                className="bg-green-50 hover:bg-green-100 p-3 sm:p-4 rounded-lg text-center transition-all transform hover:scale-105 border border-green-200 group"
              >
                <div className="text-green-600 text-xl sm:text-2xl mb-2 group-hover:scale-110 transition-transform">
                  <Plus className="w-6 h-6 sm:w-8 sm:h-8 mx-auto" />
                </div>
                <h3 className="font-medium text-green-900 text-sm sm:text-base">Add Product</h3>
              </button>
              
              <button 
                onClick={() => openBlogModal()} 
                className="bg-purple-50 hover:bg-purple-100 p-3 sm:p-4 rounded-lg text-center transition-all transform hover:scale-105 border border-purple-200 group"
              >
                <div className="text-purple-600 text-xl sm:text-2xl mb-2 group-hover:scale-110 transition-transform">
                  <FileText className="w-6 h-6 sm:w-8 sm:h-8 mx-auto" />
                </div>
                <h3 className="font-medium text-purple-900 text-sm sm:text-base">Write Blog</h3>
              </button>
              
              <button 
                onClick={() => openBannerModal()} 
                className="bg-yellow-50 hover:bg-yellow-100 p-3 sm:p-4 rounded-lg text-center transition-all transform hover:scale-105 border border-yellow-200 group"
              >
                <div className="text-yellow-600 text-xl sm:text-2xl mb-2 group-hover:scale-110 transition-transform">
                  <Image className="w-6 h-6 sm:w-8 sm:h-8 mx-auto" />
                </div>
                <h3 className="font-medium text-yellow-900 text-sm sm:text-base">Add Banner</h3>
              </button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-4 sm:p-6 mb-6">
            ...
            <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
              {categories.slice(0, 4).map((category) => (
                <div key={category._id} className="border border-gray-200 rounded-lg p-3 sm:p-4 hover:shadow-md transition-shadow">
                  <div className="flex items-center space-x-2 sm:space-x-3 mb-2 sm:mb-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-medium text-gray-900 truncate text-sm sm:text-base">{category.name}</h3>
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
              {products.slice(0, 4).map((product) => (
                <div key={product._id} className="border border-gray-200 rounded-lg p-3 sm:p-4 hover:shadow-md transition-shadow">
                  ...
                  />
                  <h3 className="font-medium text-gray-900 mb-1 truncate text-sm sm:text-base">{product.title}</h3>
                  <p className="text-base sm:text-lg font-semibold text-green-600 mb-1 sm:mb-2">${product.price}</p>
                  <div className="flex justify-between items-center mb-2 sm:mb-3">
                    ...
                    <span className="text-xs text-gray-500 truncate ml-2">{product.category?.name}</span>
                  </div>
          ...
          <div className="bg-white rounded-lg shadow p-4 sm:p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
              {banners.slice(0, 2).map((banner) => (
                <div key={banner._id} className="border border-gray-200 rounded-lg p-3 sm:p-4 hover:shadow-md transition-shadow">
                  <img 
                    src={banner.image?.url || '/images/placeholder.jpg'} 
                    alt={banner.title} 
                    className="w-full h-20 sm:h-32 object-cover rounded-lg mb-2 sm:mb-3" 
                  />
                  <h3 className="font-medium text-gray-900 mb-1 text-sm sm:text-base">{banner.title}</h3>
                  <p className="text-xs sm:text-sm text-gray-600 mb-2 line-clamp-2">{banner.subtitle}</p>
          ...
          <div className="bg-white rounded-lg shadow p-4 sm:p-6 mb-6">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 gap-2">
              <h2 className="text-lg font-semibold">Blog Posts ({blogs.length})</h2>
              <div className="flex space-x-2">
            ...
            {blogs.length === 0 ? (
              <div className="text-center py-6 sm:py-8">
                ...
                <p className="text-gray-500 mb-3 sm:mb-4 text-sm sm:text-base">Get started by creating your first blog post.</p>
                <Button onClick={() => openBlogModal()} size="small" className="text-xs sm:text-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                {blogs.slice(0, 3).map((blog) => (
                  <div key={blog._id} className="border border-gray-200 rounded-lg p-3 sm:p-4 hover:shadow-md transition-shadow">
                    <img 
                      src={blog.featuredImage?.url || '/images/placeholder.jpg'} 
                      alt={blog.title} 
                      className="w-full h-20 sm:h-32 object-cover rounded-lg mb-2 sm:mb-3" 
                    />
                    <h3 className="font-medium text-gray-900 mb-2 line-clamp-2 text-sm sm:text-base">{blog.title}</h3>
                    <p className="text-xs sm:text-sm text-gray-600 mb-2 sm:mb-3 line-clamp-2">{blog.excerpt}</p>
