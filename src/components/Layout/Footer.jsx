        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 items-center">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4 mt-4">
              <a
                href="https://web.facebook.com/profile.php?id=61584676931479"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/teckysloutions/"
                target="_blank"
                rel="noopener noreferrer"
                title="Instagram"
              ...
              <a
                href="https://x.com/TeckySolutions3"
                target="_blank"
                rel="noopener noreferrer"
                title="Twitter"
              ...
              <a
                href="https://www.linkedin.com/in/tecky-solutions-b7a30438b/"
                target="_blank"
                rel="noopener noreferrer"
                title="LinkedIn"
